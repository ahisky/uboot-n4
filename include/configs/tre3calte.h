 ...
 *
 * Configuation settings for the Exynos5433 TRE3CALTE board.
 */

#ifndef __SAMSUNG_TRE3CALTE_H
#define __SAMSUNG_TRE3CALTE_H
...
#define CONFIG_EXTRA_ENV_SETTINGS	"dfu_alt_info=kernel part 0 9 offset 0x400;rootfs part 0 18;system-data part 0 19;user part 0 21\0" \
					...
					"boarddetect=if itest.l *0x138000b4 == 0x0063f9ff; then setenv board tre3calte; elif itest.l *0x138000b4 == 0x0059f9ff; then setenv board tre3calte; else setenv board unknown; fi; echo Detected $board board\0" \
